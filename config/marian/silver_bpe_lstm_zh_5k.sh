...
MAIN_FOLDER="${WORKING_OUT}/zh-out/silver_bpe_lstm_zh_5k/"
# Gold files - if you do not plan on changing these after you set them,  you can also move them to default_config.sh
PRETRAINED_FOLDER="${WORKING_OUT}corpus/zh-data/gold-silver-bpe-5k/"
FINETUNED_FOLDER="${WORKING_OUT}corpus/zh-data/gold-bpe-5k/"
